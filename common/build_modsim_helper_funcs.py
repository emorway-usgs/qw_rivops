...
orig_rch = [(2, 34,  1,  1,  1, 200.51,     1416.13, 0.03380275, 0.5, 0.25, 0.3, 0.2, 3.5, 1),
            (2, 34,  2,  1,  2, 409.53,     1414.13, 0.03091691, 0.5, 0.25, 0.3, 0.2, 3.5, 1),
            (2, 34,  3,  1,  3, 418.81,     1411.44, 0.02526567, 0.5, 0.25, 0.3, 0.2, 3.5, 1),
            (2, 34,  4,  1,  4,  413.8,     1408.31, 0.01977428, 0.5, 0.25, 0.3, 0.2, 3.5, 1),
            (2, 34,  5,  1,  5, 442.01,     1405.91, 0.01435245, 0.5, 0.25, 0.3, 0.2, 3.5, 1),
            (2, 34,  6,  1,  6, 415.56,     1403.21, 0.01336941, 0.5, 0.25, 0.3, 0.2, 3.5, 1),
            (2, 34,  7,  1,  7, 262.89,     1400.21, 0.00963071, 0.5, 0.25, 0.3, 0.2, 3.5, 1),
            (2, 35,  7,  1,  8,  50.05,     1400.00, 0.00963071, 0.5, 0.25, 0.3, 0.2, 3.5, 1),
            (2, 35,  8,  2,  1, 400.03,      1398.5, 0.00374972, 0.5, 0.25, 0.3, 0.2, 3.5, 1),
            (2, 35,  9,  2,  2,  291.3,        1397,  0.0085822, 0.5, 0.25, 0.3, 0.2, 3.5, 1),
            (2, 34,  9,  2,  3, 319.38,        1396, 0.01252412, 0.5, 0.25, 0.3, 0.2, 3.5, 1),
            (2, 34, 10,  2,  4,    400,        1393, 0.00999994, 0.5, 0.25, 0.3, 0.2, 3.5, 1),
            (2, 34, 11,  2,  5,    400,        1392, 0.00499994, 0.5, 0.25, 0.3, 0.2, 3.5, 1),
            (2, 34, 12,  2,  6,    400,        1391, 0.00374995, 0.5, 0.25, 0.3, 0.2, 3.5, 1),
            (2, 34, 13,  2,  7,    400,      1390.5, 0.00499994, 0.5, 0.25, 0.3, 0.2, 3.5, 1),
            (2, 34, 14,  2,  8,    400,        1389, 0.00874989, 0.5, 0.25, 0.3, 0.2, 3.5, 1),
            (2, 34, 15,  2,  9,    400,        1387, 0.00499994, 0.5, 0.25, 0.3, 0.2, 3.5, 1),
            (2, 34, 16,  2, 10, 455.89,        1387, 0.00219351, 0.5, 0.25, 0.3, 0.2, 3.5, 1),
            (2, 34, 17,  2, 11,    130,        1386, 0.00769229, 0.5, 0.25, 0.3, 0.2, 3.5, 1),
            (2, 35, 17,  2, 12, 439.46,        1386, 0.00769229, 0.5, 0.25, 0.3, 0.2, 3.5, 1),
            ...
            (2, 44, 31,  6,  1,   0.73, 1384.079949, 0.00018191, 0.5, 0.04, 0.3, 0.2, 3.5, 1),
            ...
            (2,  6, 73, 32,  1,   0.25, 1361.411116, 0.00005634, 0.5, 0.04, 0.3, 0.2, 3.5, 1),
            ...
            (2, 43, 94, 43,  1,   0.11, 1334.829992, 0.00026953, 0.5, 0.04, 0.3, 0.2, 3.5, 1),
            ...
            (2, 41,117, 43, 34, 377.94, 1332.053384, 0.00026953, 0.5, 0.04, 0.3, 0.2, 3.5, 1),
            (2, 41,118, 43, 35, 408.67, 1331.947377, 0.00026953, 0.5, 0.04, 0.3, 0.2, 3.5, 1),
            (2, 41,119, 43, 36, 403.41, 1331.837937, 0.00026953, 0.5, 0.04, 0.3, 0.2, 3.5, 1),
            ...
            (2, 33, 81, 50, 17,   0.18,     1327.08,33.10948422, 0.5, 0.25, 0.3, 0.2, 3.5, 1),
            ...
            (2, 34,125, 54,  6,  358.7,     1265.95,  0.0103605, 0.5, 0.25, 0.3, 0.2, 3.5, 1),
...
def determine_runoff_conns_4mvr(pth):
    ...
    elev_arr = np.loadtxt(os.path.join(pth,'dis_support','top_2xmodel.txt'), dtype=np.float)
    ibnd     = np.loadtxt(os.path.join(pth,'bas_support','ibnd1_2xmodel.txt'), dtype=np.int)
    ...
    np.savetxt(os.path.join(pth, 'uzf_support','irunbnd_mf6_2x.txt'), sfrlayout_new, fmt='%5d')
...
def generate_irrig_events(delr, delc, iuzno_cell_dict, static_mvrperioddata):
    ...
    for i in np.arange(183, len(df), step=1):
